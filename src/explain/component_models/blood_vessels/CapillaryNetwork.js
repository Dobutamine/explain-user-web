...
export class CapillaryNetwork extends BaseModelClass {
  ...
  constructor(model_ref, name = "") {
    ...
    // dependent variables
    this.flow = 0.0;                                      // flow through the network (L/s)
    this.flow_art = 0.0;                                  // flow through the network (L/s)
    this.flow_ven = 0.0;                                  // flow through the network (L/s)

    this.pres = 0.0;                                      // pressure in the network (mmHg)
    this.pres_art = 0.0;                                  // pressure in the arterioles (mmHg)
    this.pres_cap = 0.0;                                  // pressure in the capillaries (mmHg)
